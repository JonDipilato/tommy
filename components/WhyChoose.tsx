...
const points = [
  {
    ...
    body: "Above ASE Certified Standards and AC Certified — trained to do the job right the first time.",
  },
  {
    title: "Straightforward communication",
    body: "Real explanations, real pricing, no upsells. You always know what's happening and why.",
  },
  {
  ...
  {
    title: "Local shop you can call directly",
    body: "Pick up the phone and talk to the people working on your vehicle — no call center, no runaround.",
  },
];
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-navy-950 sm:text-4xl">
              A shop that earns repeat customers the old-fashioned way.
            </h2>
            <p className="mt-5 text-lg text-navy-900/70">
              Honest diagnosis, clear pricing, and quality work — whether
              it's a quick oil change or a stubborn check engine light no one
              else could pin down.
            </p>
          </div>
